    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                <el-button type="primary" icon="el-icon-circle-plus" class="handle-del mr10" @click="addVisible = true">
                    新增
                </el-button>
                <el-select placeholder="类别筛选" v-model="userTypeID" clearable class="handle-select mr10"
            ...
            <el-table :data="userList" border
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button size="small" type="primary" @click="handleView(scope.$index, scope.row)">查看
                        </el-button>
            ...
            <el-form ref="form" :model="form" label-width="50px">
                ...
                <el-form-item label="角色">
                    <el-select v-model="form.role_id" placeholder="请选择">
                        <el-option v-for="item in userTypeList" :key="item.id" :label="item.note"
        ...
        <el-dialog title="用户信息详情" :visible.sync="detailVisible" width='40%' :lockScroll='false'>
            <el-card shadow="hover" class="mgb20">
                <div class="user-info">
                    <img :src="getImgUrl(userDetail.avatar)" class="user-avator" alt="">
