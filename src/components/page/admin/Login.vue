    ...
    <el-dialog title="注册" :visible.sync="isVisible" width="40%" v-loading="addLoading" center>
        <el-form ref="addform" :model="addform" :rules="addRules" status-icon label-width="70px">
            ...
            <el-form-item label="验证码" prop="validCode">
              <el-col :span="12"><el-input v-model="addform.validCode"></el-input></el-col>
              <el-col :span="6" :offset="1"><Identify :identifyCode="identifyCode"></Identify></el-col>
              <el-col :span="5"><el-button @click="refreshCode" icon="el-icon-refresh">刷新</el-button></el-col>
            </el-form-item>
        </el-form>
                    ...
                    api.getToken(params).then((res) => {
                        if (res.data.status === 'ok') {
                            ...
                            api.getRoleAndAuth({
                                ...
                                if (res.data.status == 'ok') {
                                    let authList = res.data.info.list;
